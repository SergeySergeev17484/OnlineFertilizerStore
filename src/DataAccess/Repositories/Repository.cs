...
{
    private readonly IDbContextFactory<OnlineFertilizerStoreDbContext> _contextFactory;

    public Repository(IDbContextFactory<OnlineFertilizerStoreDbContext> contextFactory)
    {
